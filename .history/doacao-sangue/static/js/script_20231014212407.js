...
function formatarTelefone(cep) {
    // Formata o Telefone no formato (81) 9.9999-9999 ou (81) 9999-9999
    if (cep.length ==) {
        return cep.replace(/(\d{2})(\d{5})(\d{4})/, "(81) $1$
    } else {
        return cep.replace(/(\d{2})(\d{4})(\d{4})/, "(81) $1-$2");
    }
  }
