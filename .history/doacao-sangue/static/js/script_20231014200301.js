...
function validarDataNascimento(data) {
 const regexDataNascimento = /^(19|20)\d\d[-](0[1-9]|1[012])[-](0[1-9]|[12][0-9]|3[01])$/;
 let result = regexDataNascimento.test(data);
 console.log(result);
 return result;
}
...
inputCpf.addEventListener("change", () => {
  ...
  console.log(validarDataNascimento(inputDataNascimento.value));
});
/*
inputDataNascimento.addEventListener("click", () => {
