...
// Adiciona a class Catálogo dentro de classProject
const classCatalogo = document.createElement("div");
classCatalogo.className = "classCatalogo";
classProject.appendChild(classCatalogo);

// Inserir 1ø produto no catálogo
inserirCardProduto(
  (parent = classCatalogo),
...
inserirCardProduto(
    ...
    (imageAlt = "Jenga Clássico Hasbro"),
    (nomeItem = "Jenga Clássico Hasbro"),
    (descreveItem =
      "Jenga Clássico Hasbro modelo A2120"),
    (precoItem = "R$ 89,00")
  );

// Inserir 4ø produto no catálogo
inserirCardProduto(
    (parent = classCatalogo),
    (imageSrc = "static/images/item-004-cara-cara.webp"),
    (imageAlt = "Jogo de mesa Cara a cara"),
    (nomeItem = "Jogo de mesa Cara a cara"),
    (descreveItem =
      "Jogo de mesa Cara a cara Com aplicativo Estrela"),
    (precoItem = "R$ 98,79")
  );

//  Função para criar os cads de produtos
