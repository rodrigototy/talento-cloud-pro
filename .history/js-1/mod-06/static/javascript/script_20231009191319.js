...
const h2DescreveItem = document.createElement("p");
h2DescreveItem.className = "h2DescreveItem";
h2DescreveItem.innerText = "Patinete Scooter dobrável com freio modelo Bv008 na cor Azul";
cardInfoItem.appendChild(h2DescreveItem);
