...
inserirCardProduto(parent, imageSrc, imageAlt, nomeItem, descreveItem, precoItem) {
    parent = "classProject","static/images/item-001-patinete.webp"};

function inserirCardProduto(parent, imageSrc, imageAlt, nomeItem, descreveItem, precoItem) {
  ...
  cardImageItem.alt = "Patinete Scooter Dobrável";
  ...
  h3PrecoItem.innerText = "R$ 139,60";
